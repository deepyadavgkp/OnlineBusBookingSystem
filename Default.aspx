...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="margin-top:6%">
        <div class="row">
            <div class="col-lg-12">
                <asp:Image ID="imgBus" ImageAlign="AbsMiddle" ImageUrl="~/img/DeepBus.jpg" style=" width:100%"    runat="server" />
               <%-- slider start--%>
                <%--<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src= "~BusBookingProject/img/DeepBus.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src= "~BusBookingProject/img/DeepBus.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src= "~BusBookingProject/img/DeepBus.jpg" alt="Third slide">
    </div>
  </div>
</div>--%>
                 <%--slider End--%>
